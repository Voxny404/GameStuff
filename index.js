...
gameController.setAttribute('href', that.replace('index.html','') + 'src/components/gameController/gamePad.html');
app.appendChild(document.createElement('br'));
app.appendChild(gameController);

let gameIntro = document.createElement('a');
gameIntro.innerText = 'gameIntro';
gameIntro.setAttribute('href', that.replace('index.html','') + 'src/components/gameIntro/gameIntro.html');
app.appendChild(document.createElement('br'));
app.appendChild(gameIntro);

let gameObject = document.createElement('a');
gameObject.innerText = 'gameObject';
gameObject.setAttribute('href', that.replace('index.html','') + 'src/components/gameObject/gameDisplay.html');
app.appendChild(document.createElement('br'));
app.appendChild(gameObject);

let imageLoader = document.createElement('a');
imageLoader.innerText = 'imageLoader';
imageLoader.setAttribute('href', that.replace('index.html','') + 'src/components/imageLoader/gameDisplay.html');
app.appendChild(document.createElement('br'));
app.appendChild(imageLoader);

let imageLoader2 = document.createElement('a');
imageLoader2.innerText = 'ImageLoader Animation';
imageLoader2.setAttribute('href', that.replace('index.html','') + 'src/components/imageLoader/gameDisplay2.html');
app.appendChild(document.createElement('br'));
app.appendChild(imageLoader2);

let textObject = document.createElement('a');
textObject.innerText = 'textObject';
textObject.setAttribute('href', that.replace('index.html','') + 'src/components/textObject/gameDisplay.html');
app.appendChild(document.createElement('br'));
...
virtuelController.setAttribute('href', that.replace('index.html','') + 'src/components/virtualGameController/exampleVGC.html');
app.appendChild(document.createElement('br'));
